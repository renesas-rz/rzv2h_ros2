...
TARGET_CC_ARCH += " -L${RECIPE_SYSROOT}/usr/lib64 \"
...
do_compile:prepend() {
    ...
    cp ${COMPONENTS_DIR}/${MACHINE_ARCH}/mmngr-user-module/usr/lib/libmmngr.so ${RECIPE_SYSROOT}/usr/lib64/
    cp ${COMPONENTS_DIR}/${MACHINE_ARCH}/mmngrbuf-user-module/usr/lib/libmmngrbuf.so ${RECIPE_SYSROOT}/usr/lib64/
}
